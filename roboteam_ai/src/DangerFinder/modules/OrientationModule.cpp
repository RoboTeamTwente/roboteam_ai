...
namespace rtt {
    namespace ai {
        namespace dangerfinder {
            ...
            OrientationModule::OrientationModule(double factor, double scalar, double danger) : factor(factor),
                                                                                                scalar(scalar),
                                                                                                DangerModule(danger) {}

            PartialResult
            OrientationModule::calculate(const roboteam_msgs::WorldRobot &bot, const roboteam_msgs::World &world) {
