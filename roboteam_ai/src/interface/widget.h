...
class Visualizer : public QWidget {
    ...
    private:
        float factor;
        int fieldmargin = Constants::getInt("WINDOW_FIELD_MARGIN");
        ...
        // toggles
        bool showRoles = Constants::getBool("STD_SHOW_ROLES");
        bool showTactics = Constants::getBool("STD_SHOW_TACTICS");
        bool showTacticColors = Constants::getBool("STD_SHOW_TACTICS_COLORS");
        bool showAngles = Constants::getBool("STD_SHOW_ANGLES");
        bool showVelocities = Constants::getBool("STD_SHOW_VELOCITIES");
        bool showPath = Constants::getBool("STD_SHOW_PATHS_CURRENT");
        bool showAllPaths = Constants::getBool("STD_SHOW_PATHS_ALL");
        bool showBallPlacementMarker = Constants::getBool("STD_SHOW_BALL_PLACEMENT_MARKER");
};
