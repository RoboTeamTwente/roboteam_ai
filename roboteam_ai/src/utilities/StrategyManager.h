...
private:
    const std::vector<RefGameState> gameStates = {
         ...
         RefGameState(RefCommand::PREPARE_SHOOTOUT_US,  "time_out_strategy",               "keeper_penalty_tactic",   "default",  false, RefCommand::DO_SHOOTOUT),
         RefGameState(RefCommand::PREPARE_SHOOTOUT_THEM,"time_out_strategy",               "keeper_penalty_tactic",   "default",  false, RefCommand::DEFEND_SHOOTOUT),
         // follow up commands
         ...
         RefGameState(RefCommand::DO_SHOOTOUT,          "time_out_strategy",               "keeper_default_tactic",   "default", true),
         RefGameState(RefCommand::DEFEND_SHOOTOUT,      "time_out_strategy",               "keeper_penalty_tactic",   "default", true)
    };
