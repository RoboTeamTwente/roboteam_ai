...
struct StrategyMap {
  ...
  StrategyMap() : commandId(RefGameState::UNDEFINED), strategyName(""), followUpCommandId(RefGameState::UNDEFINED) { }
  StrategyMap(RefGameState commandId, std::string strategyName, RefGameState followUpCommandId = RefGameState::UNDEFINED) :
...
private:
    ...
    std::vector<StrategyMap> strategyMaps = {
        ...
        {RefGameState::PREPARE_KICKOFF_THEM, "rtt_emiel/PrepareKickoffThemStrategy", RefGameState::DEFEND_KICKOFF},
