...
private:
    const std::vector<RefGameState> gameStates = {
         ...
         RefGameState(RefCommand::STOP,                 "stop_strategy",                   "keeper_formation_tactic", "stop"),
         RefGameState(RefCommand::TIMEOUT_US,           "time_out_strategy",               "keeper_time_out_tactic",  "stop"),
