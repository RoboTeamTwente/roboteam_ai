...
bt::Node::Status CanPlay::onUpdate() {
    std::cout<<GameStateManager::getCurrentGameState().strategyName<<" : " << GameStateManager::getCurrentGameState().ballPositionAtStartOfGameState.dist(ball->pos) << "m"<<std::endl;
