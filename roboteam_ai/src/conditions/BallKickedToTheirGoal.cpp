...
#include "BallKickedToTheirGoal.h"
...
BallKickedToTheirGoal::BallKickedToTheirGoal(std::string name, bt::Blackboard::Ptr blackboard)
        :Condition(std::move(name), std::move(blackboard)) { };

bt::Node::Status BallKickedToTheirGoal::onUpdate() {
