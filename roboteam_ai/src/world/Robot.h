...
public:
    ...
    public:
        ...
        Robot();
        explicit Robot(int id, const Angle &angle, const Vector2 &pos, const Vector2 &vel, double w,
                Team team = invalid, unsigned char genevaState = 3,
                unsigned char dribblerState = 0, unsigned long worldNumber = 0);
