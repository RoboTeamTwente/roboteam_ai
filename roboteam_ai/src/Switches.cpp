...
bt::Node::Ptr Switches::tacticSwitch(std::string name, bt::Blackboard::Ptr properties) {
    ...
    std::map<std::string, std::vector<std::pair<std::string, robotType>>> tactics = {
            ...
            {"new_robot_tactic", {
                    ...
                    {"role2", robotType::RANDOM},
                    {"role3", robotType::RANDOM},
                    {"role4", robotType::RANDOM},
                    {"role5", robotType::RANDOM},
                    {"role6", robotType::RANDOM},
                    {"role7", robotType::RANDOM},
                    {"role8", robotType::RANDOM},
            }
            }
    };
