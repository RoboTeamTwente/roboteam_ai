...
TEST(CoachTest, it_handles_ballplacement_positions) {
    ...
    EXPECT_FLOAT_EQ(ballplacementTarget.dist(Coach::getBallPlacementAfterPos(0.2)), Constants::getDouble("BP_MOVE_BACK_DIST"));
    ...
    EXPECT_FLOAT_EQ(Vector2(World::getBall()->pos).dist(Coach::getBallPlacementBeforePos(World::getBall()->pos)), Constants::getDouble("BP_MOVE_TOWARDS_DIST"));
}
