...
//    ros::NodeHandle nh;
////    ros::Subscriber sub = nh.subscribe<roboteam_msgs::RobotCommand>(rtt::TOPIC_COMMANDS, 0, &robotCommandCallback);bb->setString("ROLE","test");
//
//    auto bb = std::make_shared<bt::Blackboard>();
//    rtt::ai::Kick kick("kt", bb);
//    kick.properties->setString("ROLE", "kt");
...
//    rtt::ai::robotDealer::robotDealer->removeTactic("KickTest");
//}
//
