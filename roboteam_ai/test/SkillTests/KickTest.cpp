...
TEST(KickTest, It_sends_proper_robotcommands) {
    ...
    EXPECT_EQ(commands.at(0).kicker_vel, rtt::ai::Constants::getDouble("DEFAULT_KICK_POWER"));
...
TEST(KickTest, It_chips) {
    ...
    EXPECT_EQ(commands.at(0).chipper_vel, rtt::ai::Constants::getDouble("DEFAULT_KICK_POWER"));
    robotDealer::RobotDealer::removeTactic("KickTest");
}
