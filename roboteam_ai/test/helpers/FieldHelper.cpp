...
void FieldHelper::addDefenseAreas(roboteam_msgs::GeometryFieldSize &field, double defenseAreaWidth, double defenseAreaDepth) {
    ...
    field.bottom_right_penalty_stretch.begin =  Vector2{field.field_length / 2 - defenseAreaDepth, -defenseAreaWidth / 2};
    ...
    field.bottom_left_penalty_stretch.begin = Vector2{-field.field_length / 2 + defenseAreaDepth, - defenseAreaWidth / 2};
