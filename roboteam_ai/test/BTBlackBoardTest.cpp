...
TEST(BTBlackBoardTest, Blackboard) {
    ...
    ASSERT_EQ(bbmsg.getInt("int_a"), 0);
    ...
    ASSERT_EQ(bb.getVector2("vector2_a").x, 1);
    ASSERT_EQ(bb.getVector2("vector2_a").y, 1);
    ASSERT_EQ(bb.getVector2("vector2_b").x, -1.6180339887);
    ASSERT_EQ(bb.getVector2("vector2_b").y, 3.162277660168);
    ASSERT_EQ(bb.getVector2("vector2_c").x, 42.0);
    ASSERT_EQ(bb.getVector2("vector2_c").y, -42);
    ...
    ASSERT_EQ(bb.hasVector2("vector2_a"), true);
    ASSERT_EQ(bb.hasDouble("double_a"), true);
    ...
    ASSERT_EQ(bb2.getVector2("vector2_c").x, 0);
