...
TEST(DefensiveCoachTest,it_calculates_blockPoint) {
    ...
    auto blockPoint= cc::g_defensivePositionCoach.getBlockPoint(segment, pointPos,colllisionRadius);
    ...
    auto blockPoint2 = cc::g_defensivePositionCoach.getBlockPoint(std::make_pair(middlePoint,endPos), pointPos,colllisionRadius);
