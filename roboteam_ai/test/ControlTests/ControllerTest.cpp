...
TEST(ControllerTest, it_calculates_proper_pid) {
    ...
    double expectedI = (1.0/Constants::getInt("tickRate")) * 12 * 20;
    EXPECT_EQ(c.controlI(12), expectedI);
    double expectedD = 30 * (12 / (1.0/Constants::getInt("tickRate")));
    ...
    EXPECT_EQ(c.timeDiff, 1.0/Constants::getInt("tickRate"));
