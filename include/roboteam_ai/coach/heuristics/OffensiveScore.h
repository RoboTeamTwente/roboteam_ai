...
private:
    double CLOSE_TO_GOAL_WEIGHT = 1.0;
    double SHOT_AT_GOAL_WEIGHT = 1.0;
    double PASS_LINE_WEIGHT = 2.0;
    double DISTANCE_TO_OPPONENT_WEIGHT = 1.0;
    double DISTANCE_TO_BALL_WEIGHT = 1.0;
    double ANGLE_TO_GOAL_WEIGHT = 3.0;
