...
#ifndef ROBOTEAM_AI_NEWCONTROLUTILS_H
#define ROBOTEAM_AI_NEWCONTROLUTILS_H
...
namespace rtt::ai::control {
    ...
    public:
        ...
        static bool
        isPointProjectedOnLineSegment(const Vector2 &pointToCheck, const Vector2 &lineBegin, const Vector2 &lineEnd);
        ...
        static Vector2
        projectPositionToWithinField(const Field &field, Vector2 position, double margin = Constants::ROBOT_RADIUS());
        ...
        static Vector2 velocityLimiter(const Vector2 &vel, double maxVel = Constants::MAX_VEL(), double minVel = 0.0,
        ...
        static Vector2 accelerationLimiter(const Vector2 &targetVel, const Vector2 &prevVel, const Angle &targetAngle,
                                           double sidewaysAcceleration = Constants::MAX_ACC_LOWER() /
                                                                         Constants::TICK_RATE(),
                                           double forwardsAcceleration = Constants::MAX_ACC_UPPER() /
                                                                         Constants::TICK_RATE(),
                                           double sidewaysDeceleration = Constants::MAX_DEC_LOWER() /
                                                                         Constants::TICK_RATE(),
                                           double forwardsDeceleration = Constants::MAX_DEC_UPPER() /
                                                                         Constants::TICK_RATE());
        ...
        static world_new::view::RobotView
        getRobotClosestToLine(std::vector<world_new::view::RobotView> robots, Vector2 const &lineStart,
...
#endif  // ROBOTEAM_AI_NEWCONTROLUTILS_H
