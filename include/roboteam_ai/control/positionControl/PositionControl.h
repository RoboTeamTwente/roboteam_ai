...
class PositionControl {
   ...
   public:
     ...
     */
    rtt::BB::CommandCollision computeAndTrackPathBBT(const rtt::world::World *world, const rtt::world::Field &field, int robotId, Vector2 currentPosition, Vector2 currentVelocity,
     ...
     * @return An optional with a new path
     */
    std::optional<BB::BBTrajectory2D> findNewPath(const rtt::world::World *world, const rtt::world::Field &field, int robotId, Vector2 &currentPosition, Vector2 &currentVelocity,
     ...
     * @return An optional with a new path
     */
    std::vector<std::pair<Vector2, Vector2>> findNewDiscretizedPath(const rtt::world::World *world, const rtt::world::Field &field, int robotId, Vector2 &currentPosition,
     ...
     */
    std::optional<BB::BBTrajectory2D> calculatePathFromNewStart(const rtt::world::World *world, const rtt::world::Field &field,
    ...
    std::vector<std::pair<Vector2, Vector2>> calculateDiscretePathThroughIntermediate(const rtt::world::World *world, const rtt::world::Field &field,
