...
class PositionUtils {
   public:
    ...
    static Vector2 getPositionBehindPositionToPosition(world_new::view::BallView ball, double distanceBehindBall, const Vector2 &behindPosition, const Vector2 &toPosition);
