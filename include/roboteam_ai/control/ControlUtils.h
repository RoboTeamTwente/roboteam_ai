...
class ControlUtils {
   public:
    ...
    static bool pointInTriangle(const Vector2 &pointToCheck, const Vector2 &tp1, const Vector2 &tp2, const Vector2 &tp3);

    static bool pointInRectangle(const Vector2 &pointToCheck, const Vector2 &sp1, const Vector2 &sp2, const Vector2 &sp3, const Vector2 &sp4);
    ...
    static rtt::Vector2 twoLineIntersection(const Vector2 &a1, const Vector2 &a2, const Vector2 &b1, const Vector2 &b2);
    static double twoLineForwardIntersection(const Vector2 &a1, const Vector2 &a2, const Vector2 &b1, const Vector2 &b2);
    static int lineOrientation(const Vector2 &p, const Vector2 &q, const Vector2 &r);
    static bool lineSegmentsIntersect(const Vector2 &lineAStart, const Vector2 &lineAEnd, const Vector2 &lineBStart, const Vector2 &lineBEnd);
