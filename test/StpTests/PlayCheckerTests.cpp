...
//
//    void calculateInfoForScoredRoles(rtt::world::World* world) noexcept override {return;}
//
...
//    uint8_t score(rtt::ai::stp::PlayEvaluator& playEvaluator) noexcept override { return 0; }
//
//    rtt::ai::Dealer::FlagMap decideRoleFlags() const noexcept override { return {}; }
//
//    void calculateInfoForRoles() noexcept override {}
