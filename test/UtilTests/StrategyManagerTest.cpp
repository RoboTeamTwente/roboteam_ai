...
TEST(StrategyManagerTest, StrategyManagerTest) {
    ...
    strategyManager.setCurrentRefGameState(RefCommand::NORMAL_START, stage, std::nullopt);
    EXPECT_EQ(strategyManager.getCurrentRefGameState().strategyName, "normal_play_strategy");

    strategyManager.setCurrentRefGameState(RefCommand::HALT, stage, std::nullopt);
    ...
    strategyManager.setCurrentRefGameState(RefCommand::PREPARE_KICKOFF_US, stage, std::nullopt);
    ...
    strategyManager.forceCurrentRefGameState(RefCommand::NORMAL_START, std::nullopt);
    EXPECT_EQ(strategyManager.getCurrentRefGameState().strategyName, "normal_play_strategy");
    ...
    strategyManager.setCurrentRefGameState(RefCommand::PREPARE_PENALTY_US, stage, std::nullopt);
    ...
    strategyManager.setCurrentRefGameState(RefCommand::PREPARE_PENALTY_THEM, stage, std::nullopt);
    EXPECT_EQ(strategyManager.getCurrentRefGameState().strategyName, "time_out_strategy");
