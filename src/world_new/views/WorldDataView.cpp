...
std::optional<RobotView> WorldDataView::getFutureRobot(const RobotView robotView, double d) { return robotView; }

// TODO Implement this function
std::optional<BallView> WorldDataView::getFutureBall(double d) {}
