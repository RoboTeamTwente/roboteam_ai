...
namespace rtt::ai::stp::play {
    ...
    BallPlacement::BallPlacement() {
        roles = std::array<std::unique_ptr<Role>, rtt::ai::Constants::ROBOT_COUNT()>{
                ...
                std::make_unique<TestRole>(TestRole("receive")),    std::make_unique<TestRole>(TestRole("test_role_5")),
    ...
    uint8_t BallPlacement::score(world_new::World* world) noexcept { return 13; }

    void BallPlacement::assignRoles() noexcept {
    ...
    std::vector<Vector2> BallPlacement::calculateDefensivePositions(int numberOfDefenders, world_new::World* world, std::vector<world_new::view::RobotView> enemyRobots) {
    ...
    bool BallPlacement::isValidPlayToStart(world_new::World* world) noexcept { return true; }

    bool BallPlacement::isValidPlayToKeep(world_new::World* world) noexcept { return true; }
