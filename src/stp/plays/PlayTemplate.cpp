...
PlayTemplate::PlayTemplate() : Play() {
    ...
    roles = std::array<std::unique_ptr<Role>, rtt::ai::Constants::ROBOT_COUNT()>{
        std::make_unique<role::Keeper>("keeper"),    std::make_unique<role::Formation>("role_0"), std::make_unique<role::Formation>("role_1"),
...
bool PlayTemplate::shouldEndPlay() noexcept { return false; }
