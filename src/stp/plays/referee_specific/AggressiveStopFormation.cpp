...
void AggressiveStopFormation::calculateInfoForRoles() noexcept {
    ...
    stpInfos["defender_0"].setPositionToMoveTo(pos::getPosition(stpInfos["defender_0"].getPositionToMoveTo(),gen::gridLeftTop, gen::BlockingPosition, field, world));
    stpInfos["defender_1"].setPositionToMoveTo(pos::getPosition(stpInfos["defender_1"].getPositionToMoveTo(),gen::gridLeftMid, gen::BlockingPosition, field, world));
    stpInfos["defender_2"].setPositionToMoveTo(pos::getPosition(stpInfos["defender_2"].getPositionToMoveTo(),gen::gridLeftBot, gen::BlockingPosition, field, world));
