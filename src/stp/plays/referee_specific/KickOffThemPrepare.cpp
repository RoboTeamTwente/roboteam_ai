...
void KickOffThemPrepare::calculateInfoForRoles() noexcept {
    ...
    // regular bots
    stpInfos["formation_0"].setPositionToMoveTo(Vector2(-length / 4, 0.0));
    stpInfos["formation_1"].setPositionToMoveTo(Vector2(-length / 8, 0.0));
    stpInfos["formation_2"].setPositionToMoveTo(Vector2(-length / 8, 0.0));
    stpInfos["formation_3"].setPositionToMoveTo(Vector2(-length / 8, 0.0));
    ...
    stpInfos["formation_6"].setPositionToMoveTo(Vector2(defense_line_x, 0.0));
    stpInfos["formation_7"].setPositionToMoveTo(Vector2(-length / 4, 0.0));
    stpInfos["formation_8"].setPositionToMoveTo(Vector2(-length / 4, 0.0));
