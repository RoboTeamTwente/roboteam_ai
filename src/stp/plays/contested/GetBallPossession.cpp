...
void GetBallPossession::calculateInfoForRoles() noexcept {
    ...
    stpInfos["midfielder_0"].setPositionToMoveTo(
        PositionComputations::getPosition(stpInfos["midfielder_0"].getPositionToMoveTo(), field.getGrid().topMiddleCell().getPoints(), gen::SafePosition, field, world));
    ...
    stpInfos["midfielder_2"].setPositionToMoveTo(
        PositionComputations::getPosition(stpInfos["midfielder_2"].getPositionToMoveTo(), field.getGrid().bottomMiddleCell().getPoints(), gen::SafePosition, field, world));
