...
Status Rotate::onUpdate(const StpInfo &info) noexcept {
    ...
    int targetDribblerSpeed = targetDribblerPercentage / 100.0 * control_constants::MAX_DRIBBLER_CMD;
    ...
    // Check if successful
    double errorMargin = control_constants::GO_TO_POS_ANGLE_ERROR_MARGIN * M_PI;
