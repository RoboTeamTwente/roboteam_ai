...
namespace rtt::ai::interface {
    ...
    MainWindow::MainWindow(const rtt::world_new::World &worldManager, QWidget *parent, ApplicationManager *manager)
            : QMainWindow(parent) {
        setMinimumWidth(800);
        ...
        MainWindow::configureCheckableMenuItem("show rolenames", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowRoles(bool)), Constants::STD_SHOW_ROLES());
        MainWindow::configureCheckableMenuItem("show tacticnames", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowTactics(bool)), Constants::STD_SHOW_TACTICS());
        MainWindow::configureCheckableMenuItem("show tacticColors", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowTacticColors(bool)), Constants::STD_SHOW_TACTICS_COLORS());
        MainWindow::configureCheckableMenuItem("show angles", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowAngles(bool)), Constants::STD_SHOW_ANGLES());
        MainWindow::configureCheckableMenuItem("show velocities", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowVelocities(bool)), Constants::STD_SHOW_VELOCITIES());
        MainWindow::configureCheckableMenuItem("show robot shortcomings", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowRobotInvalids(bool)),
                                               Constants::STD_SHOW_ROBOT_INVALIDS());
        MainWindow::configureCheckableMenuItem("Show marker for BallPtr Placement", "show rolenames", viewMenu,
                                               visualizer, SLOT(setShowBallPlacementMarker(bool)),
        ...
        MainWindow::configureCheckableMenuItem("show debug values in terminal", "show rolenames", viewMenu, visualizer,
                                               SLOT(setShowDebugValueInTerminal(bool)),
                                               Constants::STD_SHOW_DEBUG_VALUES());
        MainWindow::configureCheckableMenuItem("Inverse interface", "show rolenames", viewMenu, visualizer,
                                               SLOT(setToggleFieldDirection(bool)), false);
...
/// Set up a checkbox and add it to the layout
    void
    MainWindow::configureCheckBox(const QString &title, QLayout *layout, const QObject *receiver, const char *method,
                                  bool defaultState) {
    ...
    void
    MainWindow::configureCheckableMenuItem(QString title, const QString &hint, QMenu *menu, const QObject *receiver,
                                           const char *method, bool defaultState) {
...
// when updating the robotswidget it needs the current visualizer state
    ...
    void MainWindow::setTacticForRobot(std::string const &str, uint8_t id) {
        visualizer->setTacticForRobot(str, id);
    }
