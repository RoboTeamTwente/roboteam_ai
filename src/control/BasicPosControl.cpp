...
RobotCommand BasicPosControl::getRobotCommand(world::World * world, FieldMessage *field, const RobotPtr &robot,
...
RobotCommand BasicPosControl::getRobotCommand(world::World * world, FieldMessage *field, const PosController::RobotPtr &robot, const Vector2 &targetPos) {
