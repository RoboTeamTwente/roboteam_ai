...
world_new::view::RobotView NewControlUtils::getRobotClosestToLine(std::vector<world_new::view::RobotView> robots, Vector2 const &lineStart, Vector2 const &lineEnd,
                                                                  bool lineWithEnds) {
    int maxDist = INT_MAX;
...
Vector2 NewControlUtils::getInterceptPointOnLegalPosition(const Field &field, Vector2 position, Line line, bool canMoveInDefenseArea, bool canMoveOutOfField,
