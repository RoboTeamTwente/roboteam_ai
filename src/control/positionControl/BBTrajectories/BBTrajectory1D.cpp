...
namespace rtt::BB {
    ...
    BBTrajectory1D::BBTrajectory1D(double startPos, double startVel, double endPos, double maximumVel,
                                   double maximumAcc)
            :
            initialPos{startPos},
            initialVel{startVel},
    ...
    BBPosVelAcc BBTrajectory1D::getValues(double t) const {
        ...
        return BBPosVelAcc(piece.startPos + piece.startVel * tPiece + 0.5 * piece.acc * tPiece * tPiece,
