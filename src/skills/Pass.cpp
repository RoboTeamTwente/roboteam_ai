...
void Pass::makeCommand() {
    ...
    shotdata = robot->getShotController()->getRobotCommand(*robot, getKicker(), forcePass, control::PASS, false, control::HIGH);
...
void Pass::initiatePass() { coach::g_pass.initiatePass(robot->id); }
