...
void StrategyManager::setCurrentRefGameState(RefCommand command, proto::SSL_Referee_Stage stage, std::optional<::rtt::world::view::BallView> ballOpt) {
...
void StrategyManager::forceCurrentRefGameState(RefCommand command, std::optional<::rtt::world::view::BallView> ballOpt) {
    // we need to change refgamestate here
